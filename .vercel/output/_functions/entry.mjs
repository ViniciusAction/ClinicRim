...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_e3FNWi_3.mjs';
import { manifest } from './manifest_eXEbLbfm.mjs';
...
const _args = {
    "middlewareSecret": "0bcd8b8e-353f-4877-b4d8-fcdff9feeeab",
